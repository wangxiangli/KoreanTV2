package com.gaojunhui.koreantv.homefragment.moviefragment.movieadapterfragment;
 ...
 */
public class MovieHomeAdapter extends RecyclerView.Adapter<MovieHomeAdapter.MyViewHolder> {
    private List<HomeMovie.CardBean.DataBean> list;
    ...
    public MovieHomeAdapter(List<HomeMovie.CardBean.DataBean> list, Context context) {
        this.list = list;
    ...
    public void onBindViewHolder(MyViewHolder holder, int position) {
        ...
        holder.tv_num.setText(list.get(position).getScore());
