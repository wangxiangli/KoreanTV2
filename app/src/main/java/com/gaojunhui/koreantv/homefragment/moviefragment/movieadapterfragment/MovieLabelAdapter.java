 ...
 */
public class MovieLabelAdapter extends RecyclerView.Adapter<MovieLabelAdapter.MyViewHolder> {
    ...
    public MovieLabelAdapter(List<HomeMovie.CardBean.DataBean> list, Context context) {
        this.list = list;
